...
@Component
@Profile("worker")
@ExternalTaskSubscription("searchRoundTripRoutes")
@RequiredArgsConstructor
public class SearchRoundTripRoutesWorker implements ExternalTaskHandler {
    ...
    public void execute(ExternalTask task, ExternalTaskService service) {
        try {
            ...
            SearchResponseDTO result = ticketSearchService.searchSimpleRoutes(reqDto, true, 0, 10);
