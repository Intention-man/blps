package aviasales.ticket.management.config;
...
@EnableJpaRepositories(
        basePackages = {
                "aviasales.common.repository",
                "aviasales.ticket.management.messaging"
        },
...
public class AtomikosConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        em.setPackagesToScan("aviasales.common.data", "aviasales.ticket.management.messaging");
    ...
    private Properties jpaProperties() {
        ...
        properties.put("hibernate.transaction.jta.platform", "aviasales.ticket.management.config.AtomikosJtaPlatform");
