...
public class TemporaryTicketService {
    ...
    public String storeTicket(TicketDTO ticket, String jobId) {
        ...
        try {
            ...
            throw new RuntimeException("Failed to serialize aviasales.data.ticket from jobId = " + jobId, e);
        }
        ...
        return repository.findById(ticketId)
                .map(t -> {
                    try {
                        ...
                        throw new RuntimeException("Failed to deserialize aviasales.data.ticket", e);
                    }
                })
                .orElse(null);
    }
